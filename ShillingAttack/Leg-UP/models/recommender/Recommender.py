...
class AutoRec(Recommender):
    ...
    def prepare_data(self):
        ...
        self.train_data_mask_array = np.sign(self.train_data_array)
        ...
        for i in range(total_batch):
            ...
            _, loss_ = self.sess.run(
                ...
                feed_dict={
                    ...
                    self.rating_matrix_mask: np.sign(self.train_matrix[:, batch_set_idx].toarray()),
...
class NeuMF(Recommender):
    ...
    def build_network(self):
        ...
        concat_input = tf.concat([mlp_item_latent_factor, mlp_user_latent_factor], axis=1)
        layer_1 = tf.keras.layers.Dense(
            # inputs=tf.concat([mlp_item_latent_factor, mlp_user_latent_factor], axis=1),
            units=self.num_factor_mlp * 2,
            kernel_initializer=tf.random_normal_initializer,
            activation=tf.nn.relu,
            kernel_regularizer=regularizer)(concat_input)
        ...
        layer_2 = tf.keras.layers.Dense(
            ...
            activation=tf.nn.relu,
            kernel_initializer=tf.random_normal_initializer,
            kernel_regularizer=regularizer)(layer_1)
        ...
        layer_3 = tf.keras.layers.Dense(
            ...
            activation=tf.nn.relu,
            kernel_initializer=tf.random_normal_initializer,
            kernel_regularizer=regularizer)(layer_2)
        ...
        layer_4 = tf.keras.layers.Dense(
            ...
            activation=tf.nn.relu,
            kernel_initializer=tf.random_normal_initializer,
            kernel_regularizer=regularizer)(layer_3)

        _MLP = tf.keras.layers.Dense(
            # inputs=layer_4,
            units=self.hidden_dimension,
            activation=tf.nn.relu,
            kernel_initializer=tf.random_normal_initializer,
            kernel_regularizer=regularizer)(layer_4)
...
class NNMF(Recommender):
    ...
    def build_network(self):
        ...
        regularizer = tf.keras.regularizers.l2(self.reg_rate)
        layer_1 = tf.keras.layers.Dense(#inputs=input,
                                        units=2 * self.num_factor_1 + self.num_factor_2,
                                  bias_initializer=tf.random_normal_initializer,
                                  kernel_initializer=tf.random_normal_initializer, activation=tf.sigmoid,
                                  kernel_regularizer=regularizer)(input)
        layer_2 = tf.keras.layers.Dense(#inputs=layer_1,
                                        units=self.hidden_dimension, activation=tf.sigmoid,
                                  bias_initializer=tf.random_normal_initializer,
                                  kernel_initializer=tf.random_normal_initializer,
                                  kernel_regularizer=regularizer)(layer_1)
        layer_3 = tf.keras.layers.Dense(#inputs=layer_2,
                                        units=self.hidden_dimension, activation=tf.sigmoid,
                                  bias_initializer=tf.random_normal_initializer,
                                  kernel_initializer=tf.random_normal_initializer,
                                  kernel_regularizer=regularizer)(layer_2)
        layer_4 = tf.keras.layers.Dense(#inputs=layer_3,
                                        units=self.hidden_dimension, activation=tf.sigmoid,
                                  bias_initializer=tf.random_normal_initializer,
                                  kernel_initializer=tf.random_normal_initializer,
                                  kernel_regularizer=regularizer)(layer_3)
        output = tf.keras.layers.Dense(#inputs=layer_4,
...
class NRR(Recommender):
    ...
    def build_network(self):
        ...
        regularizer = tf.keras.regularizers.l2(self.reg_rate)
        layer_1 = tf.keras.layers.Dense(#inputs=input,
                                  units=self.d, bias_initializer=tf.random_normal_initializer,
                                  kernel_initializer=tf.random_normal_initializer, activation=tf.sigmoid,
                                  kernel_regularizer=regularizer)(input)
        layer_2 = tf.keras.layers.Dense(#inputs=layer_1,
                                  units=self.hidden_dimension, activation=tf.sigmoid,
